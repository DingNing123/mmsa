...
class getFeatures():
    ...
    def __paddingSequence(self, sequences):
        ...
        # 因为Mosi数据集 长度相差很大，因此取均值+1 std填充。
    ...
    def results(self, output_dir):
        ...
        with open(os.path.join(self.data_dir,"meld.pkl"), "rb") as handle:
        ...
        test_data = data["test"]
        # train_data.keys()
        # dict_keys(['text', 'audio', 'label', 'segment'])
        ...
        # save
        save_path = os.path.join(self.data_dir, output_dir, 'meld.pkl')
        ...
        if not os.path.exists(DATASET_FILE):
            ...
            print('Oops, May be it exists %s ! ' % save_path)


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default='/media/dn/85E803050C839C68/m_fusion_data/',
                        help='path to MOSI')

    parser.add_argument('--pretrainedBertPath', type=str, default='/media/dn/85E803050C839C68/tools/bert-base-uncased',
...
if __name__ == "__main__":
    ...
    # different dataset diff output dir
    gf.results('bert_meld')
