...
class getFeatures():
    ...
    def __align(self, words, visual, acoustic):
        ...
        # Satire is related to speed of speech
        speed = int( len_words / len_visual * 10 )
        ...
        return words, visual, acoustic, speed
    ...
    def results(self, output_dir):
        ...
        for i in tqdm(range(len(df_label_T))[:]):
            ...
            words, visual, acoustic, speed = self.__align(words, visual, acoustic)
            data_point = (words, visual, acoustic), label_id, segment, (label_id_t,label_id_a,label_id_v), speed
        ...
        import pickle
        save_path = os.path.join(self.data_dir, output_dir, 'mmsa_mag_speed.pkl')
