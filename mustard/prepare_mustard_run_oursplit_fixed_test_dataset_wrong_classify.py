...
from data.load_data import MMDataLoader1
...
def run(args):
    ...
    if args.debug_mode:
        ...
        results = atio.do_confusion_matrix(model, dataloader['valid'], mode="VAL")
    else:
        results = atio.do_confusion_matrix(model, dataloader['test'], mode="TEST")
...
def parse_args():
    ...
    parser.add_argument('--modelName', type=str, default='lf_dnn1',
                        help='support mult/tfn/lmf/mfn/ef_lstm/lf_dnn/lf_dnn1/mtfn/mlmf/mlf_dnn'
                             'lf_dnn1 : residual paper1 three level fusion')
    # 需要修改索引 = 5
    parser.add_argument('--datasetName', type=str, default='mustard_oursplit',
                        help='support mosi/sims/mustard/mustard_oursplit')
    ...
    parser.add_argument('--data_dir', type=str, default='/media/dn/85E803050C839C68/m_fusion_data/bert_mustard/',
