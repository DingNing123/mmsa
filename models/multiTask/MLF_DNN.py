...
class TextSubNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print('textsubnet lstm final_states[0] shape: ', final_states[0].shape)
...
class MLF_DNN(nn.Module):
    ...
    def __init__(self, args):
        ...
        print('construct MLF_DNN class in file MLF_DNN.py ...  ')
        print()
        ...
        print('self.audio_in,self.audio_hidden')
        print(self.audio_in,self.audio_hidden)

        print('self.video_in,self.video_hidden')
        print(self.video_in,self.video_hidden)

        print('self.text_in,self.text_hidden,self.text_out')
        print(self.text_in,self.text_hidden,self.text_out)
    ...
    def forward(self, text_x, audio_x, video_x):
        print('model mlf_dnn forward in file MLF_DNN.py')
        ...
        print('audio_x shape', audio_x.shape)
        print('audio_x shape', video_x.shape)
        print('text_x shape', text_x.shape)
        ...
        print('audio_h.shape,video_h.shape,text_h.shape: batch 2 ;  16 128 32 ')
